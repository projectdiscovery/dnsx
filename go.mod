...
require (
	...
	github.com/projectdiscovery/retryabledns v1.0.13-0.20220127061702-003711f5f9b4
	github.com/projectdiscovery/stringsutil v0.0.0-20220120150443-138d7af18587 // indirect
