...
func ParseOptions() *Options {
	...
	flagSet.CreateGroup("configs", "Configurations",
		...
		flagSet.BoolVarP(&options.AutoWildcard, "auto-wildcard", "aw", false, "automatically detect and filter wildcard subdomains across multiple domains"),
...
func (options *Options) validateOptions() {
	...
	// auto-wildcard and wildcard-domain are mutually exclusive
